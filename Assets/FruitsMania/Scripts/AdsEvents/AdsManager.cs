...
namespace dotmob.Scripts.AdsEvents
{
    ...
    public class AdsManager : UnityEngine.MonoBehaviour
    {
        ...
        private string admobRewardedUIDAndroid;
        private string admobUIDIOS;
        private string admobRewardedUIDIOS;
        private string admobBannerAndroid;
        private string admobBannerIOS;
...
#if UNITY_ANDROID
            banner = new BannerView(admobBannerAndroid, AdSize.Banner, AdPosition.Bottom);
#elif UNITY_IOS
...
#elif UNITY_ANDROID
			string adUnitId = admobRewardedUIDAndroid;
#elif UNITY_IOS
