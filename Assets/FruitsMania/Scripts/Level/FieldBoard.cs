...
using dotmob.Scripts.Effects;
using dotmob.Scripts.Items;
using dotmob.Scripts.System;
using dotmob.Scripts.System.Combiner;
using dotmob.Scripts.System.Pool;
...
//            yield return new WaitForEndOfFrame();
         ...
         {
             var squareType = (SquareTypes)Enum.Parse(typeof(SquareTypes), type.Replace("dotmob.Scripts.TargetScripts.",""));
