...
namespace dotmob.Scripts.Level
{
    ...
    public class LevelData
    {
        ...
        public void SetTarget(int index)
        {
            ...
            try
            {
                targetObject = (Target)Activator.CreateInstance(Type.GetType("dotmob.Scripts.TargetScripts."+target.name));
        ...
        public LevelData DeepCopy(int level)
        {
            ...
            other.targetObject = (Target)Activator.CreateInstance(Type.GetType("dotmob.Scripts.TargetScripts."+target.name));
