...
using dotmob.Scripts.LinqConstructor.AnyFieldInspector.Editor;
...
public class TargetEditor : EditorWindow
{
    ...
    void OnEnable()
    {
        targetObject = AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Resources/Levels/TargetEditorScriptable.asset", typeof(TargetEditorScriptable)) as TargetEditorScriptable;
