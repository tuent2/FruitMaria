...
using dotmob.Scripts.AdsEvents;
using dotmob.Scripts.Blocks;
...
using dotmob.Scripts.Level.ItemsPerLevel.Editor;
...
namespace dotmob.Scripts.Editor
{
    [InitializeOnLoad]
    public class LevelMakerEditor : EditorWindow
    {
        ...
        private string[] sectionsString = { "Blocks", "Items", "Directions" };
        ...
        string levelPath = "Assets/FruitsMania/Resources/Levels/";
        ...
        [MenuItem("dotMob/Level-editor-Config")]
        ...
        private void OnFocus()
        {
            ...
            arrows[0] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow.png", typeof(Texture));
            arrows[1] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_left.png", typeof(Texture));
            arrows[2] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_right.png", typeof(Texture));
            arrows[3] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_up.png", typeof(Texture));
            arrows[4] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/circle arrow.png", typeof(Texture));
            arrows[5] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/circle arrows.png", typeof(Texture));

            //teleports[0] =
            //    (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/teleport_icon1.png", typeof(Texture));
            //teleports[1] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/teleport_icon2.png", typeof(Texture));

            arrows_enter[0] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_red.png", typeof(Texture));
            arrows_enter[1] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_left.png", typeof(Texture));
            arrows_enter[2] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_right.png", typeof(Texture));
            arrows_enter[3] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_up.png", typeof(Texture));
...
//                        GUIMamalade();
        ...
        private void GUIShowWarning()
        {
            ...
            GUILayout.Label("Please open scene - game ( Assets/FruitsMania/Scenes/game.unity )", EditorStyles.boldLabel,
                GUILayout.Width(600));
        }
...
//            GooglePlayServices.PlayServicesResolver.MenuResolve();//2.1.2
        ...
        private void GUIAds()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            initscript.rewardedGems = EditorGUILayout.IntField("Rewarded coins count", initscript.rewardedGems,
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            adsSettings.admobBannerAndroid = EditorGUILayout.TextField("Admob Banner ID Android ",
                adsSettings.admobBannerAndroid, GUILayout.Width(220), GUILayout.MaxWidth(220));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            adsSettings.admobBannerIOS = EditorGUILayout.TextField("Admob Banner ID IOS ",
                adsSettings.admobBannerIOS, GUILayout.Width(220), GUILayout.MaxWidth(220));
            GUILayout.EndHorizontal();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            adsSettings.admobRewardedUIDAndroid = EditorGUILayout.TextField("Admob Rewarde ID Android ",
                adsSettings.admobRewardedUIDAndroid, GUILayout.Width(220), GUILayout.MaxWidth(220));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Space(20);
            adsSettings.admobRewardedUIDIOS = EditorGUILayout.TextField("Admob Rewarde ID IOS ",
                adsSettings.admobRewardedUIDIOS, GUILayout.Width(220), GUILayout.MaxWidth(220));
            GUILayout.EndHorizontal();
#endif
...
//            GUILayout.EndHorizontal();
        ...
        {
            GUILayout.Label("Fruits Mania - Match 3 Unity Template version 1.1", EditorStyles.boldLabel,
                GUILayout.Width(400));
            ...
            {
                Application.OpenURL("https://docs.google.com/document/d/1KOCuuY3GzfBJp83-PShrD0V67kF_zAT1eJenzC90Q-A/edit?usp=sharing");
            }
...
//        GUILayout.Space(20);
        ...
        private void GUIShops()
        {
            ...
            GUILayout.Space(10);
            gems_shop_show = EditorGUILayout.Foldout(gems_shop_show, "Coins shop settings:");
            if (gems_shop_show)
            {
                int i = 1;
                foreach (GemProduct item in lm.gemsProducts)
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Space(30);
                    GUILayout.Label("Coins count", GUILayout.Width(100));
        ...
        private void TestLevel(bool playNow = true, bool testByPlay = true)
        {
            dirtyLevel = true;
            SaveLevel(levelNumber);
            if (EditorSceneManager.GetActiveScene().name != sceneSwitcher.GetSceneName()) EditorSceneManager.OpenScene("Assets/FruitsMania/Scenes/" + sceneSwitcher.GetSceneName()+".unity");
            LevelManager lm = Camera.main.GetComponent<LevelManager>();
